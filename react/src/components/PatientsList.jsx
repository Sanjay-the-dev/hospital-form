...
return(
 ...
 {/* nav bar  */}
    ...
    <div className="form_btn_group   page_margin">
      ...
      <Button variant="contained" sx={{ position:"fixed", top:"15px", right:"190px"}}  color="warning" onClick={()=>{setPatientsPopup(true)}}> Add Patient</Button>

      <Button variant="contained" sx={{ position:"fixed", top:"15px", right:"80px"}}  color="error" onClick={logout}>Logout</Button>
